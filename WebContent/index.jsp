...
<body>
	<header>
		...
		<div class="md-toolbar-tools header_style">
			<img src="image/fis-logo.png" alt="image caption"
				style="width: 204px"> <label
				style="color: rgb(169, 158, 144); font-size: medium; padding-left: 32px;">
				Welcome Board Members</label>
		</div>

		</md-toolbar>
	</header>
	<div ng-app="profiles" ng-controller="profile_control">
		<div class="row" ng-hide="isVisible" layout-padding layout-wrap
			layout-fill  layout-align="center center">
			<!-- <md-whiteframe class="md-whiteframe-{{$index+1}}dp user-div"  flex-sm="45" flex-gt-sm="35" flex-gt-md="25"  layout-align="center center" ng-repeat="x in users"> -->
			<!-- <div ng-click="showAdvanced($event,$index)"    layout-align="center center" ng-repeat="x in users" style="cursor:pointer;"> -->
			<div class="col-md-3 col-sm-12 col-lg-4	" ng-repeat="x in users"
				style="cursor: pointer; padding: 0px; margin: 4px"
				ng-click="showAdvanced($event,$index)"
				style="padding-top: 16px;box-shadow: unset;line-height: 24px; ">
				<img ng-src="{{x.imagepath}}"
					style="position: relative; height: auto; width: auto;">
				<div
					style="position: absolute; color: #ffffff; margin-top: 240px; margin-left: 86px;">
					<span><b>{{x.membername}}<b></span><br> <span>{{x.memberdesignation}}</span>
				</div>
		...
		<div ng-show="isVisible" layout="row" layout-xs="column"
			layout-md="column" layout-align="space-around center">
			<div class="user-div" style="position: relative">
				<md-card> <md-card-header> <md-card-header-text>
				<span class="md-title" style="color: #16c36f">SORRY</span> <span
					class="md-subhead" style="color: #0e3965d1">Still There are
					no users</span> </md-card-header-text> </md-card-header> </md-card>
			</div>
		</div>
	</div>
</body>
